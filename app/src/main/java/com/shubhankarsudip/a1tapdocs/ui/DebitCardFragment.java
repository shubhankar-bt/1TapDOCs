...
public class DebitCardFragment extends Fragment {
    ...
    RecyclerView DebitCardPart;
    LinearLayout DebitNoData;
    private DatabaseReference reference,dbRef;
    private CardsAdapter adapter;
    ProgressBar ProgressBarloader;
    private List<uploadCARDS> list1;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.debit_cards, container, false);
         ...
         DebitCardPart = view.findViewById(R.id.DebitCardR);
         DebitNoData = view.findViewById(R.id.DebitCardNoData);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                if(!datasnapshot.exists()){
                    ...
                    DebitCardPart.setLayoutManager(new LinearLayoutManager(getContext()));
                    adapter = new CardsAdapter(list1, getContext(), 0);
